    ...
    <div className="site-shell">
      <header className="site-header">
        <div className="container header-inner">
          <NavLink className="brand" to="/" aria-label="Faith Academy home">
            ...
            <span><strong>Faith Academy</strong><small>Christian School</small></span>
          </NavLink>
          ...
          <nav id="primary-navigation" className={`primary-nav ${menuOpen ? 'is-open' : ''}`} aria-label="Primary navigation">
            ...
            <NavLink className="button button-small" to="/contact">Enquire now</NavLink>
          </nav>
        </div>
      </header>
      <main><Outlet /></main>
      <footer className="site-footer">
        <div className="container footer-inner">
          <div><img src={logo} alt="" className="footer-logo" /><p>Faith Academy Christian School</p></div>
